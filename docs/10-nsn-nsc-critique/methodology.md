...
```mermaid
flowchart LR
    P0["P0 · 阻塞<br/>正确性 / 安全 / 数据丢失"] --> A1["立即修，发布前必须解决"]
    P1["P1 · 设计正确性<br/>结构问题影响演进"] --> A2["下一个 milestone 必修"]
    P2["P2 · 质量退化<br/>重复、晦涩、可调试性差"] --> A3["逐步重构，可分摊"]
    P3["P3 · 美化<br/>命名、注释、风格"] --> A4["顺手修，不立项"]
```
...
- 引用同级文档使用相对链接 `./xxx.md` 或 `../NN-xxx/README.md`
- Mermaid 图源码同级提供 `.mmd` 文件，便于二次编辑
...
| 文档 | 状态 | 用途 |
|------|------|------|
| [../01-overview/README.md](../01-overview/README.md) | GREEN | 总览 / 四组件职责 |
| [../02-control-plane/README.md](../02-control-plane/README.md) | GREEN | 控制面契约 |
| [../03-data-plane/README.md](../03-data-plane/README.md) | GREEN（已校正源项目失真） | 隧道形态 |
| [../04-network-stack/README.md](../04-network-stack/README.md) | GREEN | smoltcp + NAT |
| [../05-proxy-acl/README.md](../05-proxy-acl/README.md) | GREEN | proxy + ACL |
| [../06-nsc-client/README.md](../06-nsc-client/README.md) | GREEN | NSC 客户端 |
| [../07-nsn-node/README.md](../07-nsn-node/README.md) | GREEN | NSN 节点生命周期 |
