...
| [`diagrams/wg-tunnel.mmd`](./diagrams/wg-tunnel.mmd) | gotatun 报文流 + UAPI 状态上报 | Mermaid graph |
| [`diagrams/ws-tunnel.mmd`](./diagrams/ws-tunnel.mmd) | WsFrame 编解码 + 多路复用 | Mermaid graph |
| [`diagrams/connector-multi.mmd`](./diagrams/connector-multi.mmd) | 多 NSGW 并发 + 健康状态机 | Mermaid flowchart |
| [`diagrams/fallback.mmd`](./diagrams/fallback.mmd) | UDP/WSS 切换时序 | Mermaid sequence |
