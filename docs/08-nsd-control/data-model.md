...
[NSD 核心实体 ER 图](./diagrams/data-model-core-er.d2)

> 这是 mock 与生产共有的最小核心实体子集。完整的生产 ER（含 SESSION / DEVICE_CODE / PORT_MAPPING / SUBNET_RULE 等 20+ 实体）见 [`diagrams/entity-relation.d2`](./diagrams/entity-relation.d2)。
