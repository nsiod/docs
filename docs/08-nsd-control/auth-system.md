...
[首次注册路径 B：Device Flow](./diagrams/auth-flow-device.d2)
...
[续签路径：Ed25519 签名认证](./diagrams/auth-flow-signature.d2)
...
[认证状态机](./diagrams/auth-state-machine.d2)
