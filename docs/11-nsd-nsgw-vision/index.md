...
| 文档 | 读者 | 内容 |
|------|------|------|
| [index.md](./index.md) | 全体 | 本文件 —— 愿景/对比/索引 |
...
- [../01-overview/index.md](../01-overview/index.md) — NSIO 四组件全景 (NSD/NSGW/NSN/NSC)
- [../08-nsd-control/index.md](../08-nsd-control/index.md) — NSD 当前契约 (REST + SSE)
- [../09-nsgw-gateway/index.md](../09-nsgw-gateway/index.md) — NSGW 当前形态 (traefik + WG + WSS)
